...
// Formate une date en tenant compte du fuseau Europe/Paris (UTC+2 en été)
...
// Décode les caractères mal encodés (latin1 → utf8)
function decode(str) {
  if (!str) return ''
  try {
...
function extraireClasse(summary = '') {
  ...
  // Essai sur le premier mot séparé par – ou -
